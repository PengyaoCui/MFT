...
const char *path [nFiles]= {
  "/Users/francisco/WORKDIR/O2/LTFOptimisation/10muons_LEta_moreEv/dev/RCut_0.0100",
...
const char *refPath = "/Users/francisco/WORKDIR/O2/LTFOptimisation/10muons_LEta_moreEv/dev/RCut_0.0100";

const char *legText [nFiles]= {
